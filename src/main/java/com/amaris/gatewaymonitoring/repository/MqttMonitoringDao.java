...
//
//@Repository
//public class MqttMonitoringDao {
//
//    private MqttClient client;
//    private final MqttConfig.MyGateway myGateway;
//
//    @Autowired
//    public MqttMonitoringDao(MqttConfig.MyGateway myGateway) {
...
//     *
//     */
//    public void startMqttListening(String brokerUrl, String username, String password, String topic, Consumer<String> onMessageReceived) {
//        try {
